...
class Manager:
    def __init__(self, parameters: Parameters):
        ...
        self.min_transfer_amount: float = 0.0
        self.max_transfer_amount: float = 999999.0
    ...
    def create_tenants_settlements(self, apartment_settlement: ApartmentSettlement) -> List[TenantSettlement]:
    ...
    def is_tenant_blacklisted(self, tenant_name: str) -> bool:
        ...
        return tenant_name in json.dumps(dane, ensure_ascii=False)

    # ✅ KLUCZOWE NAPRAWY POD TESTY

    def validate_transfer(self, transfer: Transfer) -> bool:
        return self.min_transfer_amount <= transfer.amount_pln <= self.max_transfer_amount
